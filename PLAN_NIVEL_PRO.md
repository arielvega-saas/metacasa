...
6. ✅ Widgets de sistema + Dynamic Island — hecho en **3.1**. ✅ **(verificado 2026-08-05)** El App Group `group.com.metacasa.shared` **existe** en el Developer Portal, habilitado en `com.metacasa.app` y `com.metacasa.app.widgets`, y el binario 1.1.0 build 13 lo lleva firmado en la app y en el appex. El aviso anterior estaba desactualizado.
