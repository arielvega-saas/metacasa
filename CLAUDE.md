# MetaCasa — Claude Code project guide
...
Ver `~/.claude/projects/-Users-arielvega-Desktop-metacasa-app/memory/project_metacasa_next_actions.md` para acciones concretas pendientes.
